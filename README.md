...
#### RMSE (MSE in the paper) Comparison
...
| DSformer    | **0.273** | **0.291** | **0.357** |

### Ablation Study (4-hour Forecast)

| Model Configuration | MSE   | MAE   |
|---------------------|-------|-------|
| Complete Model      | 0.147 | 0.273 |
| DeepResGCN          | 0.173 | 0.318 |
| SMARTformer         | 0.192 | 0.331 |

The model shows high stability across 100 independent runs, with minimal fluctuations in MSE and MAE.
